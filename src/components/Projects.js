...
const Projects = () => {
  return (
    <section id="projects" className="py-10 sm:p-10 md:p-16 md:text-left bg-electricblue">
      <h2 className="text-center text-5xl p-2 text-limegreen md:text-left">Projects</h2>
      <div className="flex flex-col items-center ">
        <div className="flex flex-col p-3 md:flex-row gap-10">
          {ProjectsData.map((Project) => (
            <div key={Project.id} className="max-w-[400px] rounded overflow-hidden shadow-lg text-electricblue">
